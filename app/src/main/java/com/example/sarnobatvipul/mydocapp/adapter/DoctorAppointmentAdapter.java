...
import com.example.sarnobatvipul.mydocapp.DisplayAProfileActivity;
...
public class DoctorAppointmentAdapter extends RecyclerView.Adapter<DoctorAppointmentAdapter.ViewHolder> {
    ...
    public DoctorAppointmentAdapter(Context mContext, List<Doctor> mdoctors) {
...
*/
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(mContext,DisplayAProfileActivity.class);
